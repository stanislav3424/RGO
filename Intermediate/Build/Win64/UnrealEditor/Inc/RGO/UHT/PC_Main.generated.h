...
#define FID_Users_Stas_Documents_Unreal_Projects_RGO_Source_RGO_PC_Main_h_19_DELEGATE \
RGO_API void FOnTogglePauseWidget_DelegateWrapper(const FMulticastScriptDelegate& OnTogglePauseWidget, bool bIsPause);
