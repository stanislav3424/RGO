...
struct Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature_Statics
{
	struct _Script_RGO_eventOnStaminaChanged_Parms
	{
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature_Statics::NewProp_CurrentStamina = { "CurrentStamina", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_RGO_eventOnStaminaChanged_Parms, CurrentStamina), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature_Statics::NewProp_MaxStamina = { "MaxStamina", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_RGO_eventOnStaminaChanged_Parms, MaxStamina), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature_Statics::NewProp_CurrentStamina,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature_Statics::NewProp_MaxStamina,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_RGO, nullptr, "OnStaminaChanged__DelegateSignature", Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature_Statics::_Script_RGO_eventOnStaminaChanged_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature_Statics::_Script_RGO_eventOnStaminaChanged_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature_Statics::FuncParams);
	}
...
void FOnStaminaChanged_DelegateWrapper(const FMulticastScriptDelegate& OnStaminaChanged, float CurrentStamina, float MaxStamina)
{
	...
	_Script_RGO_eventOnStaminaChanged_Parms Parms;
...
struct Z_Construct_UDelegateFunction_RGO_OnEquipmentChanged__DelegateSignature_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "CharacterLogic.h" },
...
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_RGO_OnEquipmentChanged__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_RGO, nullptr, "OnEquipmentChanged__DelegateSignature", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_RGO_OnEquipmentChanged__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_RGO_OnEquipmentChanged__DelegateSignature_Statics::Function_MetaDataParams)},  };
UFunction* Z_Construct_UDelegateFunction_RGO_OnEquipmentChanged__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_RGO_OnEquipmentChanged__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
...
// ********** Begin Class UCharacterLogic Function GetCurrentStamina *******************************
struct Z_Construct_UFunction_UCharacterLogic_GetCurrentStamina_Statics
{
	struct CharacterLogic_eventGetCurrentStamina_Parms
	{
		float ReturnValue;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCharacterLogic_GetCurrentStamina_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CharacterLogic_eventGetCurrentStamina_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UCharacterLogic_GetCurrentStamina_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCharacterLogic_GetCurrentStamina_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UCharacterLogic_GetCurrentStamina_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCharacterLogic_GetCurrentStamina_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UCharacterLogic, nullptr, "GetCurrentStamina", Z_Construct_UFunction_UCharacterLogic_GetCurrentStamina_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCharacterLogic_GetCurrentStamina_Statics::PropPointers), sizeof(Z_Construct_UFunction_UCharacterLogic_GetCurrentStamina_Statics::CharacterLogic_eventGetCurrentStamina_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCharacterLogic_GetCurrentStamina_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCharacterLogic_GetCurrentStamina_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UFunction_UCharacterLogic_GetCurrentStamina_Statics::CharacterLogic_eventGetCurrentStamina_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UCharacterLogic_GetCurrentStamina()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UCharacterLogic_GetCurrentStamina_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UCharacterLogic::execGetCurrentStamina)
{
	P_FINISH;
	P_NATIVE_BEGIN;
...
// ********** End Class UCharacterLogic Function GetCurrentStamina *********************************
...
// ********** Begin Class UCharacterLogic Function GetMaxStamina ***********************************
struct Z_Construct_UFunction_UCharacterLogic_GetMaxStamina_Statics
{
	struct CharacterLogic_eventGetMaxStamina_Parms
	{
		float ReturnValue;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCharacterLogic_GetMaxStamina_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CharacterLogic_eventGetMaxStamina_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UCharacterLogic_GetMaxStamina_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCharacterLogic_GetMaxStamina_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UCharacterLogic_GetMaxStamina_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCharacterLogic_GetMaxStamina_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UCharacterLogic, nullptr, "GetMaxStamina", Z_Construct_UFunction_UCharacterLogic_GetMaxStamina_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCharacterLogic_GetMaxStamina_Statics::PropPointers), sizeof(Z_Construct_UFunction_UCharacterLogic_GetMaxStamina_Statics::CharacterLogic_eventGetMaxStamina_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCharacterLogic_GetMaxStamina_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCharacterLogic_GetMaxStamina_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UFunction_UCharacterLogic_GetMaxStamina_Statics::CharacterLogic_eventGetMaxStamina_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UCharacterLogic_GetMaxStamina()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UCharacterLogic_GetMaxStamina_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UCharacterLogic::execGetMaxStamina)
{
	P_FINISH;
	P_NATIVE_BEGIN;
...
// ********** End Class UCharacterLogic Function GetMaxStamina *************************************
...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UCharacterLogic_Statics::NewProp_OnStaminaChanged = { "OnStaminaChanged", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCharacterLogic, OnStaminaChanged), Z_Construct_UDelegateFunction_RGO_OnStaminaChanged__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnStaminaChanged_MetaData), NewProp_OnStaminaChanged_MetaData) }; // 856386466
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCharacterLogic_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCharacterLogic_Statics::NewProp_OnStaminaChanged,
