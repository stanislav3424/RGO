...
struct Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature_Statics
{
	struct _Script_RGO_eventOnHealthChanged_Parms
	{
		float CurrentHealth;
		float MaxHealth;
	};
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature_Statics::NewProp_CurrentHealth = { "CurrentHealth", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_RGO_eventOnHealthChanged_Parms, CurrentHealth), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature_Statics::NewProp_MaxHealth = { "MaxHealth", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_RGO_eventOnHealthChanged_Parms, MaxHealth), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature_Statics::NewProp_CurrentHealth,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature_Statics::NewProp_MaxHealth,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_RGO, nullptr, "OnHealthChanged__DelegateSignature", Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature_Statics::_Script_RGO_eventOnHealthChanged_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature_Statics::_Script_RGO_eventOnHealthChanged_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature_Statics::FuncParams);
	}
...
void FOnHealthChanged_DelegateWrapper(const FMulticastScriptDelegate& OnHealthChanged, float CurrentHealth, float MaxHealth)
{
	...
	_Script_RGO_eventOnHealthChanged_Parms Parms;
...
// ********** Begin Class UItemLogic Function InitializeName ***************************************
struct Z_Construct_UFunction_UItemLogic_InitializeName_Statics
{
	struct ItemLogic_eventInitializeName_Parms
	{
		FName SetItemName;
	};
#if WITH_METADATA
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_SetItemName_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FNamePropertyParams NewProp_SetItemName;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UItemLogic_InitializeName_Statics::NewProp_SetItemName = { "SetItemName", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ItemLogic_eventInitializeName_Parms, SetItemName), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SetItemName_MetaData), NewProp_SetItemName_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UItemLogic_InitializeName_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UItemLogic_InitializeName_Statics::NewProp_SetItemName,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UItemLogic_InitializeName_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UItemLogic_InitializeName_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UItemLogic, nullptr, "InitializeName", Z_Construct_UFunction_UItemLogic_InitializeName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UItemLogic_InitializeName_Statics::PropPointers), sizeof(Z_Construct_UFunction_UItemLogic_InitializeName_Statics::ItemLogic_eventInitializeName_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UItemLogic_InitializeName_Statics::Function_MetaDataParams), Z_Construct_UFunction_UItemLogic_InitializeName_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UFunction_UItemLogic_InitializeName_Statics::ItemLogic_eventInitializeName_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UItemLogic_InitializeName()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UItemLogic_InitializeName_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UItemLogic::execInitializeName)
{
	P_GET_PROPERTY_REF(FNameProperty,Z_Param_Out_SetItemName);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->InitializeName(Z_Param_Out_SetItemName);
	P_NATIVE_END;
}
// ********** End Class UItemLogic Function InitializeName *****************************************
...
void UItemLogic::StaticRegisterNativesUItemLogic()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "InitializeName", &UItemLogic::execInitializeName },
...
struct Z_Construct_UClass_UItemLogic_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UItemLogic_InitializeName, "InitializeName" }, // 3284257737
...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UItemLogic_Statics::NewProp_OnHealthChanged = { "OnHealthChanged", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UItemLogic, OnHealthChanged), Z_Construct_UDelegateFunction_RGO_OnHealthChanged__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnHealthChanged_MetaData), NewProp_OnHealthChanged_MetaData) }; // 2318329421
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UItemLogic_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UItemLogic_Statics::NewProp_OnHealthChanged,
...
struct Z_CompiledInDeferFile_FID_Users_Stas_Documents_Unreal_Projects_RGO_Source_RGO_ItemLogic_h__Script_RGO_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UItemLogic, UItemLogic::StaticClass, TEXT("UItemLogic"), &Z_Registration_Info_UClass_UItemLogic, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UItemLogic), 3514099000U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Stas_Documents_Unreal_Projects_RGO_Source_RGO_ItemLogic_h__Script_RGO_1171788128(TEXT("/Script/RGO"),
